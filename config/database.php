...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'landlord' => [
            'driver' => env('LANDLORD_DB_CONNECTION', env('DB_CONNECTION', 'pgsql')),
            ...
            'database' => env('LANDLORD_DB_DATABASE', env('DB_DATABASE', null)),
            'username' => env('LANDLORD_DB_USERNAME', env('DB_USERNAME', null)),
            'password' => env('LANDLORD_DB_PASSWORD', env('DB_PASSWORD', null)),
            ...
            'prefix_indexes' => true,
            'schema' => env('LANDLORD_DB_SCHEMA', 'public'),
            'sslmode' => env('LANDLORD_DB_SSLMODE', env('DB_SSLMODE', 'prefer')),
        ],

        'tenant' => [
            'driver' => env('TENANT_DB_CONNECTION', env('TENANT_DB_DRIVER', env('DB_CONNECTION', 'pgsql'))),
            'url' => env('TENANT_DB_URL', env('DB_URL')),
            'host' => env('TENANT_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('TENANT_DB_PORT', env('DB_PORT', '5432')),
            // For tenants we allow an env default (useful for dev). In production
            // the SwitchTenantDatabaseTask will override the `database` config.
            'database' => env('TENANT_DB_DATABASE', null),
            'username' => env('TENANT_DB_USERNAME', env('DB_USERNAME', null)),
            'password' => env('TENANT_DB_PASSWORD', env('DB_PASSWORD', null)),
